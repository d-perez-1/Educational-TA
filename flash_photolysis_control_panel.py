...
import flash_photolysis_fn as fp

window=tk.Tk()
window.title("Flash photolysis control panel")
...
def pressed_go():
    ...
    fp.run_flash_photolysis(direct,fname,n_scan,runtime,GAIN,save_full_data,plot_deltaOD)
